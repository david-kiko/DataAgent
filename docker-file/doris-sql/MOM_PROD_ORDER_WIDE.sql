...
DROP TABLE IF EXISTS bi.MOM_PROD_ORDER_WIDE;
CREATE TABLE IF NOT EXISTS bi.MOM_PROD_ORDER_WIDE (
...
insert into bi.MOM_PROD_ORDER_WIDE
select t1.CID
  ,t1.CINTEGRATION_SYSTEM
  ,t1.CPROD_PLAN_TYPE
  ,t1.CBIZ_ORG_ID
  ,t2.CNAME as CBIZ_ORG_NAME
  ,t1.CCODE
  ,t1.CORDER_TYPE
  ,t1.CPRIORITY
  ,t1.CUNIT
  ...
  ,t1.CCONTROL_STATUS
from target.MOM_PROD_ORDER t1 
left join target.SYS_BIZ_ORG t2 on t1.CBIZ_ORG_ID = t2.CID
left join target.SYS_BIZ_ORG t3 on t1.CFACTORY_ID = t3.CID
